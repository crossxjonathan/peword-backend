...
const getDetailExperience = (id) => {
    return pool.query("SELECT id, company_name, position, month_company, year_company, description_company, created_at, updated_at FROM experience WHERE workers_id = $1", [id])
}
